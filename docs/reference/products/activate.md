...
_TODO: handwrite a 1–2 paragraph description of what `products.activate` does, when callers reach for it, and any gotchas._

## Request

See [`docs/openapi/products.json`](../../openapi/products.json) → operation `products.activate` → `requestBody`.

## Response

See [`docs/openapi/products.json`](../../openapi/products.json) → operation `products.activate` → response `200`.

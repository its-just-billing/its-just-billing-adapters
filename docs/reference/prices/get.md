...
_TODO: handwrite a 1–2 paragraph description of what `prices.get` does, when callers reach for it, and any gotchas._

## Request

See [`docs/openapi/prices.json`](../../openapi/prices.json) → operation `prices.get` → `requestBody`.

## Response

See [`docs/openapi/prices.json`](../../openapi/prices.json) → operation `prices.get` → response `200`.
